...
# TODO: КОСТЫЛЬ \/\/\/
from src.quiz.utility import validate_quiz_from_file

class ExplorerFrame(UIObject):
    def __init__(self, game: Game, behavior: int = 0) -> None:
        super().__init__(game, SURFACE_SIZE, (0, 0), "topleft", 10)
        self._enabled = False
        self._explorer = Explorer()
        self._warn = WarnFrame(game, "«Файл» уже существует.", "Вы хотите заменить его?")
